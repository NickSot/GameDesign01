...
public class RightArmAnimationController : PlayerAnimationController {

    [SerializeField] private Vector3 _location = Vector3.zero;
    public override void Start() {
        base.Start();
        _partType = BodyPartType.RightArm;
    ...
    private static readonly int Walk = Animator.StringToHash("Right_arm_walkcycle");
    private static readonly int Idle = Animator.StringToHash("Right_arm_idle");
