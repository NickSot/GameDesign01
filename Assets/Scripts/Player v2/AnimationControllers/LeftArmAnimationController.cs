...
public class LeftArmAnimationController : PlayerAnimationController {

    [SerializeField] private Vector3 _location = Vector3.zero;
    public override void Start() {
        base.Start();
        _partType = BodyPartType.LeftArm;
    ...
    private static readonly int Walk = Animator.StringToHash("Left_arm_walkcycle");
    private static readonly int Idle = Animator.StringToHash("Left_arm_idle");
